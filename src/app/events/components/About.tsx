...
export const AboutLinks: React.FC = () => {
  return (
...
const AboutLink: React.FC<AboutLinkProps> = ({ heading, imgSrc, subheading, href }) => {
  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        transition={{ type: "spring" }}
        src={imgSrc}
        className="absolute z-0 h-24 w-32 rounded-lg object-cover md:h-40 md:w-64"
